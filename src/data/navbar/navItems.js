const navDataSimple = [
  {
    ...
    name: "Early Warning",
    children: [
      { id: 11, name: "Attendence",
        children1: [
            {id: 111, name: "Graduation Attendence",link: "/warning/attendence/gradution",state: false},
            {id: 112,name: "Intermediate Attendence",link: "/warning/attendence/intermediate",state: false},
            {id: 113,name: "Higher Secondary Attendence",link: "/warning/attendence/hsecondary",state: false}  , 
            {id: 114,name: "Secondary Attendence",link: "/warning/attendence/secondary",state: false}  , 
            {id: 115,name: "Primary Attendence",link: "/warning/attendence/primary",state: false}  , 
        ],
        link: "/warning/attendence",
        state: true,
      },
      {
        id: 12, name: "Grade",
        children1: [
            {id: 121,name: "Graduation Grade",link: "/warning/grade/gradution",state: false},
            {id: 122,name: "Intermediate Grade",link: "/warning/grade/intermediate",state: false},
            {id: 123,name: "Higher Secondary Grade",link: "/warning/grade/hsecondary",state: false}  , 
            {id: 124,name: "Secondary Grade",link: "/warning/grade/secondary",state: false}  , 
            {id: 125,name: "Primary Grade",link: "/warning/grade/primary",state: false}  , 
        ],
        link: "/warning/grade",
        state: false,
      },
      {
        ...
        name: "Behavior",
        children1: [
          {id: 131,name: "Graduation behavior",link: "/warning/behavior/gradution",state: false},
          {id: 132,name: "Intermediate behavior",link: "/warning/behavior/intermediate",state: false},
          {id: 133,name: "School behavior",link: "/warning/behavior/school",state: false},
        ],
        link: "/warning/behavior",
        state: false,
      },
      {id: 14,name: "Student Data",link: "/warning",state: false},
    ],
    // link: "/warning",
    // state: false,
  },
