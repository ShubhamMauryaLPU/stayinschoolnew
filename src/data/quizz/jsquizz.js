const jsQuiz = [
    ...
    },
    {
      ...
      options: ["No difference", "`===` checks for type as well", "`==` is strict comparison", "`===` allows type coercion"],
      answer: "`===` checks for type as well"
    },
    {
    ...
    {
      question: "Which object method is used to convert a JSON string to an object?",
      options: ["JSON.parse()", "JSON.stringify()", "parse.JSON()", "String.toObject()"],
      answer: "JSON.parse()"
    },
    {
      question: "What does `setTimeout()` do?",
      options: ["Runs a function after a delay", "Runs a function immediately", "Repeats a function indefinitely", "Stops a function"],
      answer: "Runs a function after a delay"
    },
    {
      question: "Which event is fired when an HTML element is clicked?",
      options: ["onmouseover", "onchange", "onclick", "onhover"],
      answer: "onclick"
    },
    {
      question: "Which function is used to execute a function repeatedly at a fixed interval?",
      options: ["setTimeout()", "setInterval()", "repeatFunction()", "loop()"],
      answer: "setInterval()"
    },
    {
      question: "How do you check if a variable is an array in JavaScript?",
      options: ["Array.isArray(var)", "var instanceof Array", "typeof var === 'array'", "Both A and B"],
      answer: "Both A and B"
    },
    {
    ...
    },
    {
      ...
      options: ["JSON.stringify()", "JSON.parse()", "object.toString()", "String()"],
    ...
    },
    {
      ...
      options: ["function myFunction()", "def myFunction()", "void myFunction()", "fn myFunction()"],
    ...
    },
    {
      ...
      options: ["trim()", "strip()", "replace()", "clean()"],
      answer: "trim()"
    },
    {
      question: "What is a closure in JavaScript?",
      options: ["A function inside another function that has access to outer variables", "A self-invoking function", "A function that closes execution", "A function that returns another function"],
      answer: "A function inside another function that has access to outer variables"
    },
    {
      question: "Which operator is used to check if a property exists in an object?",
      options: ["in", "hasOwnProperty()", "exists", "Both A and B"],
      answer: "Both A and B"
    },
    {
