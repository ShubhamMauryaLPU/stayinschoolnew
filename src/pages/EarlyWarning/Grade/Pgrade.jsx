      ...
      try {
        ...
        if (userData.professionLogin === "teacher") {
          ...
          const filteredStudents = response.data
            .map((item) => ({
              ...item,
              children: item.children.filter(child => child.education === "primary school")
            }))
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-100 to-orange-300">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-xl font-semibold text-gray-700">Loading primary school Data</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-100 to-orange-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">primary school Performance Dashboard</h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Track and analyze student GPA performance for primary school candidates
            </p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-100 to-orange-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">My primary school Progress</h1>
          <p className="text-lg text-gray-600">
            Track your academic performance as you approach primary school
          </p>
        </div>
        ...
        {studentData.length > 0 ? (
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No primary school Data Available</h3>
            <p className="text-sm text-gray-600">
              Your primary school records will appear here once your college program data is available
            </p>
          </div>
        )}
      </div>
