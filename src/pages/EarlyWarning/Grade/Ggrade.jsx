...
const Ggrade = () => {
      ...
      try {
        ...
        if (userData.professionLogin === "teacher") {
          ...
          const filteredStudents = response.data
            .map((item) => ({
              ...item,
              children: item.children.filter(child => child.education === "college")
            }))
  ...
  const getGpaColor = (gpa) => {
    ...
    if (numGpa >= 7) return "text-emerald-600 bg-emerald-50 border-emerald-200";
    if (numGpa >= 6) return "text-amber-600 bg-amber-50 border-amber-200";
    return "text-rose-600 bg-rose-50 border-rose-200";
  };

  const getGpaIcon = (gpa) => {
    const numGpa = parseFloat(gpa) || 0;
    if (numGpa >= 7) return <FaceSmileIcon className="w-5 h-5 text-emerald-500" />;
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-100 to-orange-300">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-xl font-semibold text-gray-700">Loading Graduation Data</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-100 to-orange-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Graduation Performance Dashboard</h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Track and analyze student GPA performance for graduation candidates
            </p>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-100 to-orange-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">My Graduation Progress</h1>
          <p className="text-lg text-gray-600">
            Track your academic performance as you approach graduation
          </p>
        </div>
              ...
              <div key={index} className="bg-white rounded-xl shadow-sm overflow-hidden">
                <div className="p-6">
                  <div className="flex items-start justify-between">
                    <div>
                      <h2 className="text-xl font-bold text-gray-900">{item.course || "College Program"}</h2>
                      <p className="text-sm text-gray-500 mt-1">{item.collegeName || "College Education"}</p>
                    </div>
                    <div className="flex items-center">
                      {getGpaIcon(item.gpa)}
