      ...
      try {
        ...
        if (userData.professionLogin === "teacher") {
          const response = await axios.get(
            `https://newserversis.onrender.com//student/school/${userData.college}`
          );

          const filteredStudents = response.data
            .map((item) => item.children)
            .filter((children) => children[children.length - 1].education === "secondary school");
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-100 via-orange-50 to-orange-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-orange-700 max-w-2xl mx-auto">
            Track your secondary school attendance performance
          </p>
        </div>
