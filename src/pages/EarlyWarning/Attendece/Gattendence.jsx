      ...
      try {
        ...
        if (userData.professionLogin === "teacher") {
          ...
          const filteredStudents = response.data
            ...
            .filter((children) => children[children.length - 1].education === "college");
              ...
              >
                <div className="p-6">
                  <div className="flex items-start justify-between">
                    <div>
                      <h3 className="text-lg font-bold text-orange-900">{item.course || "Unknown Course"}</h3>
