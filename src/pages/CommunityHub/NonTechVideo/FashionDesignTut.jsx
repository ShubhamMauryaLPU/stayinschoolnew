...
const FashionDesignTut = () => {
    const fashionImage = "https://cdn-icons-png.flaticon.com/512/3177/3177367.png";

    return (
        <div>
            {NonTechSubjects.filter(subject => subject.subject === "Fashion Design").map((subject, idx) => (
                <div key={idx}>
...
export default FashionDesignTut;
