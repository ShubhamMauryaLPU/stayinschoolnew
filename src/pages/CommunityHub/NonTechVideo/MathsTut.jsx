...
const MathsTut = () => {
  const mathsImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Math-icon-rounded.svg/640px-Math-icon-rounded.svg.png"; // Maths logo

  return (
    <div>
      {NonTechSubjects.filter(subject => subject.subject === "गणित").map((subject, idx) => (
        <div key={idx}>
