...
const SocialScienceTut = () => {
  const socialScienceImage = "https://upload.wikimedia.org/wikipedia/commons/4/44/Social_Science_Logo.svg"; // Social Science logo

  return (
    <div>
      {NonTechSubjects.filter(subject => subject.subject === "सामाजिक विज्ञान").map((subject, idx) => (
        <div key={idx}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-8">
            {subject.tutorials.map((item, idx) => (
              ...
              >
                <img
                  src={socialScienceImage}
                  alt="Social Science Logo"
...
export default SocialScienceTut;
