...
const BbaTut = () => {
  const bbaImage = "https://cdn-icons-png.flaticon.com/512/2965/2965877.png";

  return (
    <div>
      {NonTechSubjects.filter(subject => subject.subject === "BBA").map((subject, idx) => (
        <div key={idx}>
