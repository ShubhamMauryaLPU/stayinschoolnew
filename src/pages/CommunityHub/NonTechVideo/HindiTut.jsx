...
const HindiTut = () => {
  const hindiImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/b/be/Hindi_banrstar.png/640px-Hindi_banrstar.png"; // Hindi logo

  return (
    <div>
      {NonTechSubjects.filter(subject => subject.subject === "हिंदी").map((subject, idx) => (
        <div key={idx}>
