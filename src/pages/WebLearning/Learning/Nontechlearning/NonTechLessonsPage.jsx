...
import { FiUsers, FiBookOpen, FiSmile, FiAward, FiClock, FiStar } from 'react-icons/fi';

const NonTechnicalLessonsPage = () => {
  ...
  const lessons = [
    ...
    },
    {
      ...
      students: 512,
      rating: 4.8,
      thumbnail: "https://images.unsplash.com/photo-1593642532973-d31b6557fa68?crop=entropy&cs=tinysrgb&fit=max&ixid=MnwzNjUyOXwwfDF8c2VhY2h8MXx8cHVibGljJTIwc3BlYWtpbmd8ZW58MHx8fHwxNjEyNjE1NjI5&ixlib=rb-1.2.1&q=80&w=1080"
    },
    {
      id: 3,
    ...
    },
    {
      ...
      students: 235,
      rating: 4.6,
      thumbnail: "https://images.unsplash.com/photo-1601593451252-91d245c77449?crop=entropy&cs=tinysrgb&fit=max&ixid=MnwzNjUyOXwwfDF8c2VhY2h8Mnx8YmFzaWMlMjBkaWdpdGFsJTIwbWFya2V0aW5nfGVufDB8fHx8&ixlib=rb-1.2.1&q=80&w=1080"
    },
    {
      id: 5,
      ...
      students: 420,
      rating: 4.8,
      thumbnail: "https://images.unsplash.com/photo-1593102346360-d9b9a5f00a63?crop=entropy&cs=tinysrgb&fit=max&ixid=MnwzNjUyOXwwfDF8c2VhY2h8Mnx8bGVhZGVyJTIwc3RpbGx8ZW58MHx8fHwxNjE3MjEzMTg1&ixlib=rb-1.2.1&q=80&w=1080"
    },
    {
      id: 6,
      ...
      students: 324,
      rating: 4.5,
      thumbnail: "https://images.unsplash.com/photo-1563258324-99d22abcc8ea?crop=entropy&cs=tinysrgb&fit=max&ixid=MnwzNjUyOXwwfDF8c2VhY2h8Mnx8Y3JlYXRpdmUlMjB3cml0aW5nfGVufDB8fHx8&ixlib=rb-1.2.1&q=80&w=1080"
    }
  ];

  const categories = [
    { id: 'all', name: 'All Courses', icon: <FiBookOpen className="mr-2" /> },
    { id: 'writing', name: 'Writing', icon: <FiSmile className="mr-2" /> },
    { id: 'communication', name: 'Communication', icon: <FiUsers className="mr-2" /> },
    { id: 'finance', name: 'Finance', icon: <FiAward className="mr-2" /> },
    { id: 'marketing', name: 'Marketing', icon: <FiClock className="mr-2" /> },
    { id: 'leadership', name: 'Leadership', icon: <FiStar className="mr-2" /> },
    { id: 'design', name: 'Design', icon: <FiBookOpen className="mr-2" /> },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold sm:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-700">
            Non-Technical Learning Hub
          </h1>
          <p className="mt-4 text-xl text-gray-700 max-w-2xl mx-auto">
            Learn vital non-technical skills to excel in your personal and professional life
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-500 to-blue-700 rounded-2xl p-8 text-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-6">Join thousands of students who have enhanced their skills with our non-technical courses.</p>
            <Link
              to="/courses"
...
export default NonTechnicalLessonsPage;
